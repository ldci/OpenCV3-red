...
print ["8-bit 1 channel image" lf]
image: as byte-ptr! cvCreateImage 640 480 IPL_DEPTH_8U 1
cvZero image
...
cvSet1D image 153920 255.0 0.0 0.0 0.0
...
;test ptr access
; image 8-bit -> integer 0..255
p: as [pointer! [integer!]] cvPtr1D image 153920 NULL
?? p
print ["Get value by pointer: " p/1 lf] ; OK renvoie 255
