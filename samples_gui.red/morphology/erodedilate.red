...
ErodeDilate: routine [ t [integer!] shape [integer!] /local an element &element][
	...
	either t < 0 [cvErode  src dst element 1] [cvDilate src dst element 1 ]
